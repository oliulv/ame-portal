    ...
    <div className="space-y-6">
      ...
      {activeTab === 'github' && (
        <div className="space-y-4">
          ...
          {/* Always show connect button — each founder should connect their own account */}
          <Card>
            <CardHeader>
              <CardTitle>
                {fullStatus?.githubConnections?.length
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-muted-foreground">
                Each founder on your team should connect their own GitHub account. Contributions are
                summed across all connected accounts.
              </p>
              <a
