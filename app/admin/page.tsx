...
export default async function AdminDashboardEntry() {
  ...
  try {
    ...
    // Re-throw redirect errors - Next.js needs to handle these
    ...
    // If there's a real error, send to cohorts management
    console.error('Error in AdminDashboardEntry:', error)
    redirect('/admin/cohorts')
  }
}
